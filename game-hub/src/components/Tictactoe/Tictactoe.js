...
class Tictactoe extends React.Component {
    ...
    handleRestart = () => {
        this.setWinner('');
        this.setCells([[null, null, null], [null, null, null], [null, null, null]]);
        this.setTurn('X');
    }
    ...
    Box = (col, row) => {
        return (<div onClick={() => this.handleClick(col, row)} className="col-3 m-2 board__box">{this.state.board[row][col]}</div>)
    }
    Board = () => {
        return (
